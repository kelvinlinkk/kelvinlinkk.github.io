...
var info = [
        ...
        ["https://www.overleaf.com/","overleaf","overleaf.svg","Overleaf comes with a complete, ready to go LaTeX environment which runs on our servers."," "],
        ["https://ezcv.tw/","EZ學習歷程","ez.png","EZ學習歷程 提供多樣化的學習歷程模板，包含：大學營隊、社團活動、校外參訪、自主學習、檢定、證照、課程學習成果等等"," "],
        ["https://www.canva.com/zh_tw/","canva","canva.svg","Canva 是免費的線上平面設計工具，你可以使用 Canva 建立社交媒體貼文、簡報、海報、影片、標誌等等。"," "],
